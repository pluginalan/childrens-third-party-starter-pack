define(function(require) {
    ...
    var getAMI = function() {
        ...
        DesktopAMI.prototype = Object.create(BaseAMI.prototype);

        DesktopAMI.prototype.openExperience = function(experienceKey) {
        };

        DesktopAMI.prototype.openParentExperience = function() {
        };
